...
read_file = pd.read_excel("scripts/TallySheetForAutumn2020.xlsx", header=3, skipfooter=1, engine= 'openpyxl')
 
# Write the dataframe object into csv file
read_file.to_csv ("scripts/TallySheetForAutumn2020.csv",
                  index = None,
                  header=True)
